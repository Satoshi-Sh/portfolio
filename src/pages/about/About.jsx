     ...
     className='about'>
       ...
       <div className="box1 sb8">
        ...
        <p>  
          ...
          At this point, I had never learned programming languages but I started learning Python in my free time with online learning materials, especially in date-related field.
        </p>
        <p>
           Short time after I started, I realized that I liked programming, so decided to leave the job and learn them on a full-time basis.
